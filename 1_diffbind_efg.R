...
########################################################################################################
H3K4me3 <- dba(sampleSheet = "H3K4me3_efg.csv")
...
write.csv(new_H3K4me3_count_def,'H3K4me3_count_efg.csv',row.names = FALSE)
write.table(new_H3K4me3_count_def[,1:4],'H3K4me3_peak_efg.bed',sep = "\t",
            quote = F,
            col.names = F,
            row.names = F)
...
setwd("C:/Users/lgs96/OneDrive - Virginia Tech/Desktop/MIA data/ChIP/count_files")
write.csv(new_H3K4me3_count_raw_def,'H3K4me3_count_efg_raw.csv',row.names = FALSE)
write.table(new_H3K4me3_count_raw_def[,1:4],'H3K4me3_peak_efg_raw.bed',sep = "\t",
            quote = F,
            col.names = F,
            row.names = F)
...
options(stringsAsFactors = F)
setwd("C:/Users/lgs96/OneDrive - Virginia Tech/Desktop/MIA data/ChIP/diffbind/inputs_sheets")
H3K27ac <- dba(sampleSheet = "H3K27ac_efg.csv")
...
setwd("C:/Users/lgs96/OneDrive - Virginia Tech/Desktop/MIA data/ChIP/count_files")
write.csv(new_H3K27ac_count_def,'H3K27ac_count_efg.csv',row.names = FALSE)
write.table(new_H3K27ac_count_def[,1:4],'H3K27ac_peak_efg.bed',sep = "\t",
            quote = F,
            col.names = F,
            row.names = F)
...
setwd("C:/Users/lgs96/OneDrive - Virginia Tech/Desktop/MIA data/ChIP/count_files")
write.csv(new_H3K27ac_count_def,'H3K27ac_count_efg_raw.csv',row.names = FALSE)
write.table(new_H3K27ac_count_def[,1:4],'H3K27ac_peak_efg_raw.bed',sep = "\t",
            quote = F,
            col.names = F,
            row.names = F)
