...
factors = read.csv('cofactors_enhancer.csv')
...
miss_2 <- c()
for (i in 1:nrow(group_BA1)) {
  if(length(which(group_BA1[i,13:23]<10)) > 0.5*ncol(group_BA1[,13:23])) miss_2 <- append(miss_2,i)
}
miss = union(miss_1,miss_2)
group_BA1 = group_BA1[-miss,]
t_group_BA1 = t(group_BA1)
umap_results <- umap(t_group_BA1,n_neighbors=11,min_dist=0.1,n_components = 6)
...
###############################B vs. A_2###############################################################
meta = bind_rows(factors[29:40,1:8],factors[12:17,1:8])
meta$condition_num = c(rep(1,12),rep(2,6))
group_BA2 = data.frame(def[,29:40],def[,12:17])
miss_1 <- c()
...
##############################B vs. A_3###############################################################
meta = bind_rows(factors[29:40,1:8],factors[18:28,1:8])
meta$condition_num = c(rep(1,12),rep(2,11))
group_BA3 = data.frame(def[,29:40],def[,18:28])
miss_1 <- c()
...
miss_2 <- c()
for (i in 1:nrow(group_BA3)) {
  if(length(which(group_BA3[i,13:23]<10)) > 0.5*ncol(group_BA3[,13:23])) miss_2 <- append(miss_2,i)
}
miss = union(miss_1,miss_2)
group_BA3 = group_BA3[-miss,]
t_group_BA3 = t(group_BA3)
umap_results <- umap(t_group_BA3,n_neighbors=11,min_dist=0.1,n_components = 6)
umaps = data.frame(umap_results[["layout"]])
umaps$condition = as.factor(meta$condition)
ggplot(umaps,mapping = aes(x=X1,y=X2,col=condition)) +
  geom_point(aes(colour = condition))
...
umap_results <- umap(t_group_D1C,n_neighbors=11,min_dist=0.1,n_components = 6)
umaps = data.frame(umap_results[["layout"]])
umaps$condition = as.factor(meta$condition)
ggplot(umaps,mapping = aes(x=X1,y=X2,col=condition)) +
  geom_point(aes(colour = condition))
...
###############################D_3 vs. C###############################################################
meta = bind_rows(factors[71:81,1:8],factors[41:52,1:8])
meta$condition_num = c(rep(1,11),rep(2,12))
group_D3C = data.frame(def[,71:81],def[,41:52])
miss_1 <- c()
for (i in 1:nrow(group_D3C)) {
  if(length(which(group_D3C[i,1:11]<10)) > 0.5*ncol(group_D3C[,1:11])) miss_1 <- append(miss_1,i)
}
miss_2 <- c()
for (i in 1:nrow(group_D3C)) {
  if(length(which(group_D3C[i,12:23]<10)) > 0.5*ncol(group_D3C[,12:23])) miss_2 <- append(miss_2,i)
}
miss = union(miss_1,miss_2)
group_D3C = group_D3C[-miss,]
t_group_D3C = t(group_D3C)
umap_results <- umap(t_group_D3C,n_neighbors=11,min_dist=0.1,n_components = 6)
umaps = data.frame(umap_results[["layout"]])
umaps$condition = as.factor(meta$condition)
ggplot(umaps,mapping = aes(x=X1,y=X2,col=condition)) +
  geom_point(aes(colour = condition))
...
###############################C vs. A_1###############################################################
meta = bind_rows(factors[41:52,1:8],factors[1:11,1:8])
meta$condition_num = c(rep(1,12),rep(2,11))
group_CA1 = data.frame(def[,41:52],def[,1:11])
miss_1 <- c()
...
miss_2 <- c()
for (i in 1:nrow(group_CA1)) {
  if(length(which(group_CA1[i,13:23]<10)) > 0.5*ncol(group_CA1[,13:23])) miss_2 <- append(miss_2,i)
}
miss = union(miss_1,miss_2)
...
###############################C vs. A_2###############################################################
meta = bind_rows(factors[41:52,1:8],factors[12:17,1:8])
meta$condition_num = c(rep(1,12),rep(2,6))
group_CA2 = data.frame(def[,41:52],def[,12:17])
miss_1 <- c()
...
###############################C vs. A_3###############################################################
meta = bind_rows(factors[41:52,1:8],factors[18:28,1:8])
meta$condition_num = c(rep(1,12),rep(2,11))
group_CA3 = data.frame(def[,41:52],def[,18:28])
miss_1 <- c()
...
miss_2 <- c()
for (i in 1:nrow(group_CA3)) {
  if(length(which(group_CA3[i,13:23]<10)) > 0.5*ncol(group_CA3[,13:23])) miss_2 <- append(miss_2,i)
}
miss = union(miss_1,miss_2)
group_CA3 = group_CA3[-miss,]
t_group_CA3 = t(group_CA3)
umap_results <- umap(t_group_CA3,n_neighbors=11,min_dist=0.1,n_components = 6)
umaps = data.frame(umap_results[["layout"]])
umaps$condition = as.factor(meta$condition)
ggplot(umaps,mapping = aes(x=X1,y=X2,col=condition)) +
  geom_point(aes(colour = condition))
...
###############################B vs. D_3###############################################################
meta = bind_rows(factors[29:40,1:8],factors[71:81,1:8])
meta$condition_num = c(rep(1,12),rep(2,11))
group_BD3 = data.frame(def[,29:40],def[,71:81])
miss_1 <- c()
...
miss_2 <- c()
for (i in 1:nrow(group_BD3)) {
  if(length(which(group_BD3[i,13:23]<10)) > 0.5*ncol(group_BD3[,13:23])) miss_2 <- append(miss_2,i)
}
miss = union(miss_1,miss_2)
...
###############################D_1 vs. A_1###############################################################
meta = bind_rows(factors[53:64,1:8],factors[1:11,1:8])
meta$condition_num = c(rep(1,12),rep(2,11))
group_D1A1 = data.frame(def[,53:64],def[,1:11])
miss_1 <- c()
...
diff_peak = peak_info[rownames(DEG_matrix),]
new_DEG_matrix = bind_cols(diff_peak,DEG_matrix)
setwd("C:/Users/lgs96/OneDrive - Virginia Tech/Desktop/MIA data/ChIP/result/differential peaks/enhancer/D1A1")
...
#########################EFG######################
setwd("C:/Users/lgs96/OneDrive - Virginia Tech/Desktop/MIA data/ChIP/count_files/")
raw_def = read.csv('enhancer_count_efg.csv')
rownames(raw_def) = raw_def[,4]
def = raw_def[,5:ncol(raw_def)]
peak_info = raw_def[,1:4]
###############################F vs. G###############################################################
meta = bind_rows(factors[92:103,1:8],factors[104:115,1:8])
meta$condition_num = c(rep(1,12),rep(2,12))
group_FG = data.frame(def[,11:22],def[,23:34])
miss_1 <- c()
...
miss_2 <- c()
for (i in 1:nrow(group_FG)) {
  if(length(which(group_FG[i,13:24]<10)) > 0.5*ncol(group_FG[,13:22])) miss_2 <- append(miss_2,i)
}
miss = union(miss_1,miss_2)
...
DEG_glia=as.data.frame(resOrdered_glia)
DEG_glia=na.omit(DEG_glia)
nrDEG_glia=DEG_glia[which(DEG_glia$padj<0.05 & abs(DEG_glia$log2FoldChange) > 1),]
choose_gene_neuron=rownames(nrDEG_glia)
...
###############################E vs. G###############################################################
meta = bind_rows(factors[82:91,1:8],factors[104:115,1:8])
meta$condition_num = c(rep(1,10),rep(2,12))
group_EG = data.frame(def[,1:10],def[,23:34])
miss_1 <- c()
for (i in 1:nrow(group_EG)) {
  if(length(which(group_EG[i,1:10]<10)) > 0.5*ncol(group_EG[,1:10])) miss_1 <- append(miss_1,i)
}
miss_2 <- c()
for (i in 1:nrow(group_EG)) {
  if(length(which(group_EG[i,11:22]<10)) > 0.5*ncol(group_EG[,11:20])) miss_2 <- append(miss_2,i)
}
miss = union(miss_1,miss_2)
...
###############################F vs. E###############################################################
meta = bind_rows(factors[92:103,1:8],factors[82:91,1:8])
meta$condition_num = c(rep(1,12),rep(2,10))
group_FE = data.frame(def[,11:22],def[,1:10])
miss_1 <- c()
...
miss_2 <- c()
for (i in 1:nrow(group_FE)) {
  if(length(which(group_FE[i,13:22]<10)) > 0.5*ncol(group_FE[,13:22])) miss_2 <- append(miss_2,i)
}
miss = union(miss_1,miss_2)
...
# ###############################D_2 vs. A_2###############################################################
# meta = bind_rows(factors[65:70,1:8],factors[12:17,1:8])
# meta$condition_num = c(rep(1,6),rep(2,6))
# group_D2A2 = data.frame(def[,65:70],def[,12:17])
# miss_1 <- c()
...
# diff_peak = peak_info[rownames(DEG_matrix),]
# new_DEG_matrix = bind_cols(diff_peak,DEG_matrix)
# setwd("C:/Users/lgs96/OneDrive - Virginia Tech/Desktop/MIA data/ChIP/result/differential peaks/enhancer/D2A2")
# all_glia = group_D2A2[rownames(DEG_glia),]
# all_matrix = data.frame(DEG_glia,all_glia)
# write.csv(all_matrix,'All_D2A2.csv')
# write.csv(new_DEG_matrix,'Differential_D2A2.csv')
# ###############################D_3 vs. A_3###############################################################
# meta = bind_rows(factors[71:81,1:8],factors[18:28,1:8])
# meta$condition_num = c(rep(1,11),rep(2,11))
# group_D3A3 = data.frame(def[,71:81],def[,18:28])
# miss_1 <- c()
...
# miss_2 <- c()
# for (i in 1:nrow(group_D3A3)) {
#   if(length(which(group_D3A3[i,12:22]<10)) > 0.5*ncol(group_D3A3[,12:22])) miss_2 <- append(miss_2,i)
# }
# miss = union(miss_1,miss_2)
...
# diff_peak = peak_info[rownames(DEG_matrix),]
# new_DEG_matrix = bind_cols(diff_peak,DEG_matrix)
# setwd("C:/Users/lgs96/OneDrive - Virginia Tech/Desktop/MIA data/ChIP/result/differential peaks/enhancer/D3A3")
