...
bedtools intersect -a $PWD/BED/$f$BED -b /home/gaoshanli/Data/Promotor/mm10/mm10Promotor.bed > $PWD/Promotor_BED/$f$BED

bedToBam -i $PWD/Promotor_BED/$f$BED -g /home/gaoshanli/Data/bed_winbed/mm10/mm10genome.bed > $PWD/Promotor_BED/$f$BAM

bedtools slop -i $PWD/Promotor_BED/$f$BED -g /home/gaoshanli/Data/bed_winbed/mm10/mm10genome.bed -b 100 > $PWD/EXTEND_BED/$f$EXT
...
macs2 callpeak -t $PWD/Promotor_BED/$f$BED -c /projects/lu_lab/Gaoshan/MIA/ChIP_seq/Input/$Group/input.bed -f BED -g mm -n $f -p 0.01 --outdir $PWD/MACS_promoter
...
/projects/lu_lab/Gaoshan/MIA/ChIP_seq/Summary_promoter.sh .
